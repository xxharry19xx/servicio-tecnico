    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        ...
        @csrf
            <div class="mb-4">
                ...
                {{-- Sugerencias de categorías ya existentes --}}
            ...
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 mb-1">Precio sugerido (S/) *</label>
        ...
        <div class="mb-4">
            ...
            <div class="flex items-center justify-between py-2 border-b border-gray-100">
                <div>
                    ...
                    <p class="text-xs text-gray-400">S/ {{ number_format($servicio->precio_sugerido, 2) }}</p>
                </div>
